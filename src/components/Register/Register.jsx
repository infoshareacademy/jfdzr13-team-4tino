    ...
    <div className={styles.registerModule}>
      <div className={styles.registerForm}>
        <h1 className={styles.welcomeTitle}>
          Witaj w <span className={styles.fourTino}>4TINO</span>
        </h1>
        ...
        <form className={styles.form} onSubmit={register}>
          ...
          <input
            type="email"
            name="email"
            placeholder="Adres e-mail: example@gmail.com"
            required
            className={errors.email ? styles.fieldError : null}
            autoComplete="off"
          />
          ...
          <div className={styles.inputContainer}>
            <input
              ...
              required
              className={errors.password ? styles.fieldError : null}
              value={password}
